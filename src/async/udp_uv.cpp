...
{
	return DYNAMIC_POINTER_CAST<udp_transceiver_uv>(udp_transceiver_uv::get_shared_ptr(req->handle));
}
...
udp_transceiver_uv::on_receive(
		...
		unsigned               flags)
{
	ptr transceiver_ptr = DYNAMIC_POINTER_CAST<udp_transceiver_uv>(get_shared_ptr(udp_handle));
