...
protected:
	...
	{
		*this =  mutable_buffer{reinterpret_cast<byte_type*>(s), static_cast<logicmill::size_type>(n), null_delete<byte_type>{}};
		return this;
	}
...
public:
	...
	{
		char_type* p = reinterpret_cast<char_type*>(const_cast<logicmill::byte_type*>(m_buf.data()));
		if (p)
		{
